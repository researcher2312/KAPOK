...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, CS_I2C_SPI_Pin|MOTOR2_B_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CS_I2C_SPI_Pin|MOTOR2_B_Pin;
  ...
  GPIO_InitStruct.Pin = OTG_FS_PowerSwitchOn_Pin|MOTOR1_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
